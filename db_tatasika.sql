...
LOCK TABLES `publication` WRITE;
/*!40000 ALTER TABLE `publication` DISABLE KEYS */;
INSERT INTO `publication` VALUES (103,5,'DDDSDS','2024-10-01 06:41:41'),(104,5,'yusdi','2024-10-01 06:46:34'),(105,5,'ioyty','2024-10-01 06:47:07'),(106,5,'uid','2024-10-01 06:55:24'),(107,5,'Rasoa','2024-10-01 06:59:54'),(108,8,'test','2024-10-01 07:00:21'),(109,8,'tsys','2024-10-01 07:16:55'),(110,5,'tyyytft','2024-10-01 07:58:49'),(111,5,'sd','2024-10-01 07:59:37');
/*!40000 ALTER TABLE `publication` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `reaction_commentaire` (
  ...
  KEY `id_commentaire` (`id_commentaire`),
  KEY `id_compte` (`id_compte`),
  CONSTRAINT `reaction_commentaire_ibfk_2` FOREIGN KEY (`id_compte`) REFERENCES `compte` (`id`)
...
LOCK TABLES `reaction_commentaire` WRITE;
/*!40000 ALTER TABLE `reaction_commentaire` DISABLE KEYS */;
INSERT INTO `reaction_commentaire` VALUES (66,44,5,'love');
/*!40000 ALTER TABLE `reaction_commentaire` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-10-01 11:10:42
